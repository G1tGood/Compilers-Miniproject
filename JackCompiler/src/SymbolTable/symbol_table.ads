...
package Symbol_Table is
   ...
   function varCount (This : in out SymbolTable; kind: identifier_kinds.IdentifierKind) return Natural;
...
private
   ...
   type SymbolTable is tagged limited record
      classTable      : tablePointer;
      subroutineTable : tablePointer;
   end record;
   ...
   --| @return table access to the correct table scope
   function getTableScope (This : in out SymbolTable; kind : in identifier_kinds.IdentifierKind) return tablePointer;
